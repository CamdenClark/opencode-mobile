 ...
 */
export const globalConfigGet = <ThrowOnError extends boolean = false>(options?: Options<GlobalConfigGetData, ThrowOnError>) => (options?.client ?? client).get<GlobalConfigGetResponses, unknown, ThrowOnError>({ url: '/global/config', ...options });
 ...
 */
export const globalConfigUpdate = <ThrowOnError extends boolean = false>(options?: Options<GlobalConfigUpdateData, ThrowOnError>) => (options?.client ?? client).patch<GlobalConfigUpdateResponses, GlobalConfigUpdateErrors, ThrowOnError>({
    url: '/global/config',
    ...options,
    headers: {
 ...
 */
export const worktreeList = <ThrowOnError extends boolean = false>(options?: Options<WorktreeListData, ThrowOnError>) => (options?.client ?? client).get<WorktreeListResponses, unknown, ThrowOnError>({ url: '/experimental/worktree', ...options });
 ...
 */
export const worktreeReset = <ThrowOnError extends boolean = false>(options?: Options<WorktreeResetData, ThrowOnError>) => (options?.client ?? client).post<WorktreeResetResponses, WorktreeResetErrors, ThrowOnError>({
 ...
 */
export const experimentalSessionList = <ThrowOnError extends boolean = false>(options?: Options<ExperimentalSessionListData, ThrowOnError>) => (options?.client ?? client).get<ExperimentalSessionListResponses, unknown, ThrowOnError>({ url: '/experimental/session', ...options });
 ...
 */
export const experimentalResourceList = <ThrowOnError extends boolean = false>(options?: Options<ExperimentalResourceListData, ThrowOnError>) => (options?.client ?? client).get<ExperimentalResourceListResponses, unknown, ThrowOnError>({ url: '/experimental/resource', ...options });
 ...
 */
export const sessionDiff = <ThrowOnError extends boolean = false>(options: Options<SessionDiffData, ThrowOnError>) => (options.client ?? client).get<SessionDiffResponses, unknown, ThrowOnError>({ url: '/session/{sessionID}/diff', ...options });
 ...
 */
export const sessionDeleteMessage = <ThrowOnError extends boolean = false>(options: Options<SessionDeleteMessageData, ThrowOnError>) => (options.client ?? client).delete<SessionDeleteMessageResponses, SessionDeleteMessageErrors, ThrowOnError>({ url: '/session/{sessionID}/message/{messageID}', ...options });

...
export type ClientOptions = {
    baseUrl: 'http://aphex.tail85c1ab.ts.net:4096' | (string & {});
};
...
export type Event = EventServerConnected | EventGlobalDisposed | EventTuiPromptAppend | EventTuiCommandExecute | EventTuiToastShow | EventTuiSessionSelect | EventInstallationUpdated | EventInstallationUpdateAvailable | EventProjectUpdated | EventServerInstanceDisposed | EventFileEdited | EventWorktreeReady | EventWorktreeFailed | EventLspClientDiagnostics | EventPermissionAsked | EventPermissionReplied | EventSessionStatus | EventSessionIdle | EventQuestionAsked | EventQuestionReplied | EventQuestionRejected | EventTodoUpdated | EventPtyCreated | EventPtyUpdated | EventPtyExited | EventPtyDeleted | EventFileWatcherUpdated | EventMcpToolsChanged | EventMcpBrowserOpenFailed | EventLspUpdated | EventVcsBranchUpdated | EventCommandExecuted | EventMessageUpdated | EventMessageRemoved | EventMessagePartUpdated | EventMessagePartDelta | EventMessagePartRemoved | EventSessionCompacted | EventSessionCreated | EventSessionUpdated | EventSessionDeleted | EventSessionDiff | EventSessionError;
